...
def draw_figure2_accuracy_score():
  ...
  fig, ax = pyplot.subplots()
  plot_cutoff_y, = pyplot.plot([0, 100], [95, 95], ':', linewidth=1.0, color='black', markeredgecolor='black', alpha=1.0)
  plot_test_generic, = pyplot.plot(x_test_generic, y_test_generic, '--o', linewidth=1.0, color='orange', markeredgecolor='orange', alpha=1.0)
  plot_test, = pyplot.plot(x_test, y_test, '-s', linewidth=1.0, color='red', markeredgecolor='red', alpha=1.0)
